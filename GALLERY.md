...
[![Report](screenshots/report-summary.png)](screenshots/report-summary.png)
*Professional report with severity breakdown and grouped findings*

### Report — Finding Details
[![Finding](screenshots/finding-detail.png)](screenshots/finding-detail.png)
*Detailed finding with evidence, payload, request, response, and reproduce curl*

### Proxy — HTTP Traffic
[![Proxy](screenshots/proxy-tab.png)](screenshots/proxy-tab.png)
